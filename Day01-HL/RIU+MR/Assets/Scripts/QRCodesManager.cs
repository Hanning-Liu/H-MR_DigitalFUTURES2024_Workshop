...
namespace Microsoft.MixedReality.SampleQRCodes
{
    ...
    public class QRCodesManager : Singleton<QRCodesManager>
    {
        ...
        public event EventHandler<QRCodeEventArgs<QR.QRCode>> QRCodeAdded;
        public event EventHandler<QRCodeEventArgs<QR.QRCode>> QRCodeUpdated;
        public event EventHandler<QRCodeEventArgs<QR.QRCode>> QRCodeRemoved;

        private SortedDictionary<Guid, QR.QRCode> qrCodesList = new SortedDictionary<Guid, QR.QRCode>();
        ...
        public IList<QR.QRCode> GetList()
        {
            lock (qrCodesList)
            {
                return new List<QR.QRCode>(qrCodesList.Values);
            }
        }
